...
main()
{
    ...
    while(c!=27)
    {
        print(_dx+2,_dy+35,"Player1 : %4d",win[1]);
        print(_dx+3,_dy+35,"Player2 : %4d",win[2]);
        print(_dx+4,_dy+35,"Draw    : %4d",win[3]);
        newgame();
        moves[1]=count(1);
        moves[2]=count(2);
        score=search_init();
        ...
        {
            win[1]++;
            test[curt[2]].gentable();
            test[curt[1]].write(curt[1]);
        }
        else
        {
            win[2]++;
            test[curt[1]].gentable();
            test[curt[2]].write(curt[2]);
        }
