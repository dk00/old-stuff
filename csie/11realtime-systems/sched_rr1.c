 ...
 */
  ...
  static /*inline*/ int
__vcpu_on_runq(struct rr_vcpu *svc)
{
  return !list_empty(&svc->runq_elem);
}

  static /*inline*/ struct rr_vcpu *
__runq_elem(struct list_head *elem)
{
  ...
  static int
__runq_insert(struct list_head *runq, struct rr_vcpu *svc)
{
  ...
  static void
runq_insert(const struct scheduler *ops, unsigned int cpu, struct rr_vcpu *svc)
{
  ...
  static inline void
__runq_remove(struct rr_vcpu *svc)
{
  BUG_ON( !__vcpu_on_runq(svc) );
 ...
 * currently running; if so, wake up the processor */
  static /*inline*/ void
runq_tickle(const struct scheduler *ops, unsigned int cpu, struct rr_vcpu *new, s_time_t now)
{
  int ipid=-1;
...
#ifndef NDEBUG
  static /*inline*/ void
__rr_vcpu_check(struct vcpu *vc)
{
...
#define RR_VCPU_CHECK(_vc)
  ...
  static void *
rr_alloc_vdata(const struct scheduler *ops, struct vcpu *vc, void *dd)
{
  struct rr_vcpu *svc;
...
/* Add and remove from runqueue assignment (not active run queue) */
  static void
__runq_assign(struct rr_vcpu *svc, struct rr_runqueue_data *rqd)
{
...
runq_assign(const struct scheduler *ops, struct vcpu *vc)
{
  ...
  static void
__runq_deassign(struct rr_vcpu *svc)
{
  BUG_ON(__vcpu_on_runq(svc));
...
runq_deassign(const struct scheduler *ops, struct vcpu *vc)
{
  ...
  static void
rr_vcpu_insert(const struct scheduler *ops, struct vcpu *vc)
{
  struct rr_vcpu *svc = vc->sched_priv;
  ...
  static void
rr_free_vdata(const struct scheduler *ops, void *priv)
{
  ...
  static void
rr_vcpu_remove(const struct scheduler *ops, struct vcpu *vc)
{
  struct rr_vcpu * const svc = RR_VCPU(vc);
  struct rr_dom * const sdom = svc->sdom;
  ...
  static void
rr_vcpu_sleep(const struct scheduler *ops, struct vcpu *vc)
{
  struct rr_vcpu * const svc = RR_VCPU(vc);
  ...
  static void
rr_vcpu_wake(const struct scheduler *ops, struct vcpu *vc)
{
  struct rr_vcpu * const svc = RR_VCPU(vc);
  s_time_t now = 0;
...
out:
  ...
  static void
rr_context_saved(const struct scheduler *ops, struct vcpu *vc)
{
  struct rr_vcpu * const svc = RR_VCPU(vc);
  s_time_t now = NOW();
...
out_up:
  ...
  static int
rr_cpu_pick(const struct scheduler *ops, struct vcpu *vc)
{
  struct rr_vcpu * const svc = RR_VCPU(vc);
  int new_cpu;
    ...
    struct xen_domctl_scheduler_op *op)
{
  ...
  static void *
rr_alloc_domdata(const struct scheduler *ops, struct domain *dom)
{
  struct rr_dom *sdom;
  int flags;
  ...
  static int
rr_dom_init(const struct scheduler *ops, struct domain *dom)
{
  struct rr_dom *sdom;
  ...
  static void
rr_free_domdata(const struct scheduler *ops, void *data)
{
  int flags;
  ...
  static void
rr_dom_destroy(const struct scheduler *ops, struct domain *dom)
{
...
/* How long should we let this vcpu run for? */
  static s_time_t
rr_runtime(const struct scheduler *ops, int cpu, struct rr_vcpu *snext)
{
  return RR_MAX_TIMER;
}
 ...
 * Find a candidate.
 */
  static struct rr_vcpu *
runq_candidate(struct rr_runqueue_data *rqd,
    ...
    const struct scheduler *ops, s_time_t now, bool_t tasklet_work_scheduled)
{
  ...
  static void
rr_dump_vcpu(struct rr_vcpu *svc)
{
  ...
  static void
rr_dump_pcpu(const struct scheduler *ops, int cpu)
{
  ...
  static void
rr_dump(const struct scheduler *ops)
{
...
static void init_pcpu(const struct scheduler *ops, int cpu)
{
  ...
  static void *
rr_alloc_pdata(const struct scheduler *ops, int cpu)
{
  ...
  static void
rr_free_pdata(const struct scheduler *ops, void *pcpu, int cpu)
{
  unsigned long flags;
  struct rr_private *prv = RR_PRIV(ops);
  struct rr_runqueue_data *rqd;
