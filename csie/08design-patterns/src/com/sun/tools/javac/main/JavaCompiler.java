...
//      System.err.println("completing " + c);//DEBUG
     ...
     */
    public void compile(List<JavaFileObject> sourceFileObjects,  //\\ �{���D�b
	...
	//\\ �n��]�p�Ҧ��@�~�K �K�W�l
	hw08.b96902120.NodeCountingVisitor v = new hw08.b96902120.NodeCountingVisitor();
        //�O�o��                              //�O�o��
	Set<JCCompilationUnit> visited = new HashSet<JCCompilationUnit>();
        java.util.Iterator<Env<AttrContext>> iterator = todo.iterator();
        while (iterator.hasNext()) {
	    JCCompilationUnit jccu = iterator.next().toplevel;
	    if (!visited.add(jccu)) continue;
	    v.count(jccu);  // �i��έp
	}
	v.list(System.out);  // �L�X���G
	//\\ �n��]�p�Ҧ��@�~�K �K�W��
