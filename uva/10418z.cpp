...
struct Q{int x,y,d,s;}q[2][10000],q2[10000];
int n,m,map[100][100],tmp1[100][100],tmp2[100][100];
void inline go(int to[100][100],int x,int y,int d){
int i,j,s,p;
    for(i=0;i<n;i++)
        for(j=0;j<m;j++)
            tmp1[i][j]=tmp2[i][j]=1;
...
main(){
int i,j,k,p,t,tt,min,magic,cn[100];
scanf("%d",&tt);
while(tt--){
