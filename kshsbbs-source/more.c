...
woju
*/
         prints("[0m[44m  ÂsÄý P.%d(%d%%)  [31;47m  (h)[30m¨D§U  [31m¡÷¡õ[PgUp][PgDn][Home][End][30m´å¼Ð²¾°Ê  [31m¡ö[q][30mµ²§ô  [0m", pageno,
(viewed * 100) / st.st_size);
      }
      else if (pageno == 1 && lino == 1) {
         if (searching == -1)
            searching = 0;
         prints("[0m[1;33;45m  ÂsÄý P.%d(%d%%)  [0;31;47m  (h)[30m¨D§U  [31m¡÷¡õ[PgUp][PgDn][Home][End][30m´å¼Ð²¾°Ê  [31m¡ö[q][30mµ²§ô  [0m",
pageno, (viewed * 100) / st.st_size);
      }
      else
         prints("[0m[0;34;46m  ÂsÄý P.%d(%d%%)  [31;47m  (h)[30m¨D§U  [31m¡÷¡õ[PgUp][PgDn][Home][End][30m´å¼Ð²¾°Ê  [31m¡ö[q][30mµ²§ô  [0m", pageno,
(viewed * 100) / st.st_size);
