...
/*
  ...
  {
    sprintf(currmsg, "[1;5;37;41mÄµ§i¡G±z¤w¶¢¸m¹L¤[¡A­YµL¦^À³¡A¨t²Î§Y±N¤ÁÂ÷¡I¡I[m");
    kill(currpid, SIGUSR2);
  }
*/
/*		       */
...
#define MAXLASTCMD 6
    ...
    for (;;)
    {
      ...
      {
        if (clen < len && x + clen < ANSILINELEN)
        {
          int i, next;
