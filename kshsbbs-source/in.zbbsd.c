...
#define BAD_HOST "/bbs1/home/bbs/etc/bad_host"
/* MH */
...
/* By Tzu 20010418
#define BANNER  "\r\n【高雄中學-紅樓築夢】◎ 高雄中學 ◎ (bbs.kshs.kh.edu.tw)\r\nFreeBSD 3.0.0-19990112-SNAP (%s) [163.15.56.3:%s]\r\n\n"
*/
#define BANNER  "\r\n\r\n\r\n\r\nPowered by FreeBSD (%s) [%s]\r\n"

#else

#define BANNER  "\r\n【高雄中學-紅樓築夢】◎ 高雄中學 ◎ (bbs.kshs.kh.edu.tw)\r\nFreeBSD 3.0.0-19990112-SNAP [163.15.56.3]\r\n\n"
/*#define BANNER  "\r\nfreebsd.ee.ntu.edu.tw ◎ 台大電機 FreeBSD俱樂部 ◎ 140.112.19.123\r\n\n"*/
    ...
    do
    {
      if (!*pid)
      {
        ...
        line[sizeof("/dev/ptyp") - 2] =
          "pqrstuwPQSTUVWXYZabcefgABCEFGhjk"[(i / 32) % 32];
...
/* MH: 為了user bbs能夠設密碼 */
  ...
  (void) setenv("TMPDIR", "/bbs1/home/bbs/tmp", 1);
  {
    char RFC931[80];
...
/* MH */
#if 0
  {
    ...
    if((fp = fopen("/bbs1/home/bbs/log/in.zbbsd.log", "a+")) == NULL)
    {
      syslog(LOG_ERR, "MH: @_@  errno == %d", errno);
    }
    else
    {
      fprintf(fp, "STEP 1 done: PID=%d\n", getpid());
      fclose(fp);
    }
  }
#endif
...
#endif
#else
  sprintf(buf, "/bbs1/home/bbs/run/bbsd.pid");
#endif
/*    */
